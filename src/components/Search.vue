                ...
                <ol class="ais-Hits-list">
                  <li class="ais-Hits-item item">
                    <a href="/computer-science/mse/itmd-510/week-12/" data-pjax-state>
                      <span>
                        计算机科学
                        <i class="ic i-angle-right"></i>Master of Software Engineering
                        <i class="ic i-angle-right"></i>ITMD 510. Object-Oriented App Develop
                      </span>Week 12.
                      <mark>J</mark>avaFx
                    </a>
                  </li>
                  ...
                  <li class="ais-Hits-item item">
                    <a href="/computer-science/mse/itmd-510/week-1/" data-pjax-state>
                      ...
                      <mark>J</mark>ava Fundamental / Best programming practices
                    </a>
                  </li>
                  <li class="ais-Hits-item item">
                    <a href="/computer-science/mse/itmd-565/lecture-9/" data-pjax-state>
                      <span>
                        计算机科学
                        <i class="ic i-angle-right"></i>Master of Software Engineering
                        <i class="ic i-angle-right"></i>ITMM 565. Rich Internet Applications
                      </span>Lecture 9.
                  ...
                  <li class="ais-Hits-item item">
                    <a href="/computer-science/mse/itmd-565/lecture-2/" data-pjax-state>
                      ...
                      <mark>J</mark>avaScript – DOM Introduction and Selecting Elements
                    </a>
                  </li>
                  <li class="ais-Hits-item item">
                    <a href="/computer-science/mse/itmd-565/lecture-10/" data-pjax-state>
                      ...
                      <mark>J</mark>avaScript library for building user interfaces
                    </a>
                  </li>
                  <li class="ais-Hits-item item">
